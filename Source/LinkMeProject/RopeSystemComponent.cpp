...
void URopeSystemComponent::ManageBendPoints(float DeltaTime)
{
        ...
        CurrentLength = FMath::Min(ComputeTotalPhysicalLength(), MaxLength);
...
void URopeSystemComponent::ApplyForcesToPlayer()
{
        ...
        const float TotalPhysicalLength = ComputeTotalPhysicalLength();
...
float URopeSystemComponent::ComputeTotalPhysicalLength() const
{
