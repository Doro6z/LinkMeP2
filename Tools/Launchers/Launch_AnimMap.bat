...
set MAP="/Game/Maps/AnimMap/Level_AnimMap"
...
REM Fallback: Custom Path or Error
echo [ERROR] Could not find UnrealEditor.exe in %UE_ROOT% (versions 5.3 to 5.7).
echo.
echo Please edit this file closely to set the correct path to your UnrealEditor.exe.
pause
exit /b

:FOUND
echo Found Editor: %EDITOR%
echo Launching on Map: %MAP%
